...
Для запуска проекта необходимо создать базу данных в PostgreSQL и указать параметры подключения в конфигурационном файле проекта.

После создания базы данных измените URL подключения к БД в файле конфигурации на ваши параметры PostgreSQL.
